...
public class RecursiveRectangleFilterTest extends TestCase {
    ...
    for (int i=0; i<ns.length; ++i) {
      ...
      for (int j=0; j<ls.length; ++j) {
        ...
        for (int k=0; k<ms.length; ++k) {
          ...
          float[] ys = Array.randfloat(n);
          float[] yr = Array.randfloat(n);
          sf.apply(x,ys);
          rf.apply(x,yr);
          assertEqual(ys,yr);
        }
      ...
      for (int i1=0; i1<ns.length; ++i1) {
        ...
        for (int j=0; j<ls.length; ++j) {
          ...
          for (int k=0; k<ms.length; ++k) {
            ...
            float[][] ys = Array.randfloat(n1,n2);
            float[][] yr = Array.randfloat(n1,n2);
            sf.apply1(x,ys);
            rf.apply1(x,yr);
            assertEqual(ys,yr);
            sf.apply2(x,ys);
        ...
        for (int i1=0; i1<ns.length; ++i1) {
          ...
          for (int j=0; j<ls.length; ++j) {
            ...
            for (int k=0; k<ms.length; ++k) {
              ...
              float[][][] ys = Array.randfloat(n1,n2,n3);
              float[][][] yr = Array.randfloat(n1,n2,n3);
              sf.apply1(x,ys);
              rf.apply1(x,yr);
              assertEqual(ys,yr);
              sf.apply2(x,ys);
  ...
  private class SFilter implements Filter {
    ...
    public void apply1(float[][] x, float[][] y) {
      int n1 = x[0].length;
      int n2 = x.length;
      float[][] f = Array.reshape(_n,1,_f);
      Conv.xcor(_n,1,_l,0,f,n1,n2,0,0,x,n1,n2,0,0,y);
    }
    public void apply2(float[][] x, float[][] y) {
      int n1 = x[0].length;
      int n2 = x.length;
      float[][] f = Array.reshape(1,_n,_f);
    ...
    public void apply1(float[][][] x, float[][][] y) {
      ...
      int n2 = x[0].length;
      int n3 = x.length;
      float[][][] f = Array.reshape(_n,1,1,_f);
    ...
    public void apply2(float[][][] x, float[][][] y) {
      ...
      int n2 = x[0].length;
      int n3 = x.length;
      float[][][] f = Array.reshape(1,_n,1,_f);
