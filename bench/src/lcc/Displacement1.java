...
/**
 * Synthetic displacements for 1-D sequences.
 * The function u(x) describes displacement.
 ...
 * @version 2006.11.26
 */
public abstract class Displacement1 {

  public static Displacement1 constant(double u, int n) {
    return new ConstantDisplacement1(u,n);
  }

  public static Displacement1 gaussian(double u, int n) {
    return new GaussianDisplacement1(u,n);
  }

  public static Displacement1 sinusoid(double u, int n) {
    return new SinusoidDisplacement1(u,n);
  }
   ...
   */
  private static class ConstantDisplacement1 extends Displacement1 {
    public ConstantDisplacement1(double u, int n) {
      super(n);
      _u = u;
    }
   ...
   */
  private static class GaussianDisplacement1 extends Displacement1 {
    public GaussianDisplacement1(double umax, int n) {
      super(n);
      _a = (n-1)/2.0;
      _b = _a/3;
      _c = umax*exp(0.5)/_b;
   ...
   */
  private static class SinusoidDisplacement1 extends Displacement1 {
    public SinusoidDisplacement1(double umax, int n) {
      super(n);
      double l = n-1;
      _a = umax;
      _b = 2.0*PI/l;
