...
double* copy(int n, const double* a) {
...
static double** _asinc = 0;
double** makeSincInterpolationTable() {
  double** asinc = new double*[NSINC];
  for (int isinc=0; isinc<NSINC; ++isinc)
    asinc[isinc] = new double[LSINC];
...
void sincInterpolation(
  int nxin, double dxin, double fxin, const double* yin,
  int nxout, const double* xout, double* yout) 
{
  if (_asinc==0)
...
void pfa3(double* z, int mu, int m,
...
void pfa4(double* z, int mu, int m,
...
void pfa5(double* z, int mu, int m,
...
void pfa7(double* z, int mu, int m,
...
void pfa8(double* z, int mu, int m,
...
void pfa9(double* z, int mu, int m,
...
void pfa11(double* z, int mu, int m,
...
void pfa13(double* z, int mu, int m,
  int j0, int j1, int j2, int j3, int j4, int j5, int j6, 
...
void pfa16(double* z, int mu, int m,
  int j0, int j1, int j2, int j3, int j4, int j5, int j6, int j7, int j8, 
...
void pfacc(int sign, int nfft, double* z) {
  int nleft = nfft;
